...
def get_arguments():
    ...
    parser.add_argument('--output-dir', type=str,  default='/media/ailab/data/yy/data/RAND_CITYSCAPES/source_density_maps', help='folder where pseudo labels are stored')
